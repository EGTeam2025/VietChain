...
// Trong configOrDefault method, thêm case cho PoT
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	default:
		// Default to PoT for custom networks
...
func (g *Genesis) Commit(db ethdb.Database, triedb *triedb.Database) (*types.Block, error) {
	...
	if config.PoT != nil && len(block.Extra()) < 32+crypto.SignatureLength {
        return nil, errors.New("can't start pot chain without signers")
    }
